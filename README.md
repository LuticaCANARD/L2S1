...
Native vision batching is experimental. The [TrashNet batch4 measurement](benchmarks/trashnet-vision-20260925/REPORT.md#native-four-image-batching-2026-09-26) verified real decoder batching and reduced processing time on RTX 3080, but all three tested CUDA checkpoints failed the existing numerical equivalence criterion. Keep fresh execution when preserving its scores and decisions is required.
