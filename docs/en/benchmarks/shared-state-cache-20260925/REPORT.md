...
[English](REPORT.md) · [한국어](../../../ko/benchmarks/shared-state-cache-20260925/REPORT.md) · [日本語](../../../ja/benchmarks/shared-state-cache-20260925/REPORT.md)
...
Across 210 paired decision comparisons per model, raw candidate logits, candidate-relative probabilities, candidate mass, selected values and abstention reasons matched exactly. The report JSON retains per-round timings, reused token counts, model/runtime hashes and numerical differences: [Qwen3](../../../../benchmarks/shared-state-cache-20260925/qwen3-0.6b-sm86.json), [Gemma 4](../../../../benchmarks/shared-state-cache-20260925/gemma4-e2b-sm86.json). The benchmark source is [`examples/benchmark_shared_state_cache.rs`](../../../../examples/benchmark_shared_state_cache.rs).
