...
The [release pipeline](../RELEASE_PIPELINE.md) publishes verified GitHub Release, npm, PyPI and native Cargo artifacts after registry setup. Packages have not been published by this local work.
