...
implicitly combined. See [the batching review](../BATCHING_API_REVIEW.md).
...
The [release pipeline](../RELEASE_PIPELINE.md) publishes validated GitHub Release, npm, PyPI and native Cargo packages using configured trusted publishers. [v0.1.1](https://github.com/LuticaCANARD/L2S1/releases/tag/v0.1.1) is available.
